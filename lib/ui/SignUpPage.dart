...
import '../SignUpBloc/SignUpState.dart';
import '../SignUpBloc/SignUpEvent.dart';
import '../SignUpBloc/SignUpbloc.dart';
  ...
  Widget build(BuildContext context) {
    ...
    final signUpButton = Material(
      ...
      child: MaterialButton(
          ...
          onPressed: () {
            //signUpBloc.add(SignInButtonPressed(email: emailEditingController.text,password: passwordEditingController.text));
